...
main() {
  ...
  kubectl set image deployment/"${MEDI_TRACK_DEPLOYMENT_NAME}"-green \
    ...
    -n "${NAMESPACE}"
  kubectl rollout restart deployment/"${MEDI_TRACK_DEPLOYMENT_NAME}"-green -n "${NAMESPACE}"
  ...
  kubectl set image deployment/"${PATIENT_RECORD_DEPLOYMENT_NAME}"-green \
    ...
    -n "${NAMESPACE}"
  kubectl rollout restart deployment/"${PATIENT_RECORD_DEPLOYMENT_NAME}"-green -n "${NAMESPACE}"
  ...
  kubectl set image deployment/"${APPOINTMENTS_DEPLOYMENT_NAME}"-green \
    ...
    -n "${NAMESPACE}"
  kubectl rollout restart deployment/"${APPOINTMENTS_DEPLOYMENT_NAME}"-green -n "${NAMESPACE}"
  ...
  kubectl set image deployment/"${NOTIFICATION_DEPLOYMENT_NAME}"-green \
    ...
    -n "${NAMESPACE}"
  kubectl rollout restart deployment/"${NOTIFICATION_DEPLOYMENT_NAME}"-green -n "${NAMESPACE}"
  ...
  kubectl set image deployment/"${FILE_HANDLER_DEPLOYMENT_NAME}"-green \
    ...
    -n "${NAMESPACE}"
  kubectl rollout restart deployment/"${FILE_HANDLER_DEPLOYMENT_NAME}"-green -n "${NAMESPACE}"
